...
# Presentación de Actividad Grupal
...
5. Neo4j se trabajo de manera local.


**Justificación del uso de las plataformas**

Ya que esta es una actividad grupal, buscamos distintas plataformas que permitieran realizar el trabajo en línea, de forma gratuita y que además facilitará la revisión y ejecución de los códigos por parte del profesor. Dentro de las opciones posibles la mejor que encontramos fue utilizar el repositorio de Github para alojar los datos (bases de datos en bruto, normalizadas y el notebook) y editor de notebook en Google Colab.
